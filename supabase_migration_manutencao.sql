-- ═══════════════════════════════════════════════════════
-- MIGRAÇÃO: Sistema de Manutenção Completo
-- Data: 2026-04-16
-- ═══════════════════════════════════════════════════════

-- 1. Adicionar setor 'manutencao' aos usuarios
...
DROP POLICY IF EXISTS "Acesso publico equipamentos" ON equipamentos;
...
DROP POLICY IF EXISTS "Acesso publico os" ON ordens_servico;
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE pubname = 'supabase_realtime' AND tablename = 'equipamentos'
  ) THEN
