...
export function AvatarPickerModal({ user, onClose, onSaved }) {
  ...
  return createPortal(
    <>
      ...
      <div onClick={onClose} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', zIndex: 99998 }}/>
      <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 99999, background: '#fff', borderRadius: 20, width: '90vw', maxWidth: 380, maxHeight: '85vh', display: 'flex', flexDirection: 'column', boxShadow: '0 25px 50px rgba(0,0,0,0.3)' }}>
        {/* Cabeçalho fixo */}
